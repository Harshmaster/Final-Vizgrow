...
List<StartupModel> itList = [
  StartupModel(
    ...
    description:
        'Adoption of latest technology for IT becoming key driver to success. We help organisations to have an IT strategy, which is best suited with their goals and which can fulfil customer’s expectations and which can drive efficiency and cost optimisation for the organisation.',
    isLeft: true,
  ), 
  StartupModel(
